...
export const MENU_URL =
  "/proxy/swiggy/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=32.219042&lng=76.3234037&restaurantId=";
export const ITEM_IMG_URL =
  "https://media-assets.swiggy.com/swiggy/image/upload/";
export const ExploreRestaurants_URL =
  "/proxy/swiggy/menu/restaurants/list/v5?lat=31.10340&lng=77.16590&collection=";
